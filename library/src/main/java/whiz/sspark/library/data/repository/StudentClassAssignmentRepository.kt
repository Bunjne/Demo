...
import whiz.sspark.library.data.data_source.remote.service.StudentClassAssignmentService
import whiz.sspark.library.data.entity.AssignmentDTO
import whiz.sspark.library.data.entity.DataWrapperX
import whiz.sspark.library.utility.NetworkManager
import whiz.sspark.library.utility.fetchX

interface StudentClassAssignmentRepository {
    fun getAssignment(classGroupId: String, page: Int, pageSize: Int): Flow<DataWrapperX<AssignmentDTO>>
}

class StudentClassAssignmentRepositoryImpl(private val context: Context,
                                           private val remote: StudentClassAssignmentService) : StudentClassAssignmentRepository {
