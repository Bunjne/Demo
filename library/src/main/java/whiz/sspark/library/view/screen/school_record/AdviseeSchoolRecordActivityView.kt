...
import whiz.sspark.library.databinding.ViewAdviseeSchoolRecordActivityBinding
import whiz.sspark.library.extension.show
import whiz.sspark.library.extension.showViewStateX

class AdviseeSchoolRecordActivityView: ConstraintLayout {
    constructor(context: Context) : super(context)
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs)
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr)

    private val binding by lazy {
        ViewAdviseeSchoolRecordActivityBinding.inflate(LayoutInflater.from(context), this, true)
    }
