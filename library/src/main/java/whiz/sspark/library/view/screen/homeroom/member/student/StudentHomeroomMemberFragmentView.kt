package whiz.sspark.library.view.screen.homeroom.member.student
...
class StudentHomeroomMemberFragmentView : ConstraintLayout {
    ...
    fun init(items: List<HomeroomMemberAdapter.Item>,
             onRefresh: () -> Unit,
        ...
        with(binding.rvMember) {
            ...
            addItemDecoration(
                CustomDividerMultiItemDecoration(
                    ...
                    dividerViewType = listOf(HomeroomMemberAdapter.HomeroomMemberAdapterViewType.STUDENT_MEMBER.type, HomeroomMemberAdapter.HomeroomMemberAdapterViewType.INSTRUCTOR_MEMBER.type)
                )
            )

            adapter = HomeroomMemberAdapter(
                context = context,
                items = items,
    ...
    fun updateRecyclerViewItems(currentItems: MutableList<HomeroomMemberAdapter.Item>, newItems: List<HomeroomMemberAdapter.Item>) {
